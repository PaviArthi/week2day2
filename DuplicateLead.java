...
public class DuplicateLead {
	...
	public static void main(String[] args) {
				...
				driver.findElement(By.xpath("//input[@name='emailAddress']")).sendKeys("arthiyellow@gmail.com");
				driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
				driver.findElement(By.xpath("(//a[@href='/crmsfa/control/viewLead?partyId=10651'])")).click();
				String oldName = driver.findElement(By.xpath("//span[text()='Arthi']")).getText();
				System.out.println("The first name before duplication is " +oldName);
				driver.findElement(By.xpath("//a[text()='Duplicate Lead']")).click();
				System.out.println(driver.getTitle());
				driver.findElement(By.xpath("//input[@name='submitButton']")).click();
				String newName = driver.findElement(By.xpath("//span[text()='Arthi']")).getText();
